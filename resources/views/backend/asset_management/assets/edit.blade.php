            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ _lang('Edit Asset') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ _lang('Edit Asset') }}</h4>
            </div>
        </div>
    </div>
                    ...
                    <form action="{{ route('assets.update', $asset) }}" method="POST">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('useful_life') is-invalid @enderror" 
                                                   id="useful_life" name="useful_life" value="{{ old('useful_life', $asset->useful_life) }}">
                                            @error('useful_life')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control @error('salvage_value') is-invalid @enderror" 
                                                   id="salvage_value" name="salvage_value" value="{{ old('salvage_value', $asset->salvage_value) }}">
                                            @error('salvage_value')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="is_leasable" name="is_leasable" 
                                               value="1" {{ old('is_leasable', $asset->is_leasable) ? 'checked' : '' }}>
                                ...
                                <div id="lease_settings" style="{{ old('is_leasable', $asset->is_leasable) ? '' : 'display: none;' }}">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i> {{ _lang('Update Asset') }}
                            </button>
