...
@section('title', _lang('Edit Voting Position'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ _lang('Edit Voting Position') }}</h3>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('voting.positions.update', $position->id) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              id="description" name="description" rows="4">{{ old('description', $position->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('max_winners') is-invalid @enderror" 
                                           id="max_winners" name="max_winners" value="{{ old('max_winners', $position->max_winners) }}" 
                                           min="1" required>
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> {{ _lang('Update Position') }}
                                </button>
                                <a href="{{ route('voting.positions.index') }}" class="btn btn-secondary">
                                    {{ _lang('Cancel') }}
                                </a>
