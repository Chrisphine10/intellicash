...
@section('title', _lang('Add Employee'))
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{ _lang('Add Employee') }}</h3>
            ...
            <div class="card-body">
                <form action="{{ route('payroll.employees.store') }}" method="POST" id="employee-form">
                    @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="pay_frequency" name="pay_frequency" required>
                                                    ...
                                                    @foreach($payFrequencies as $key => $value)
                                                        <option value="{{ $key }}" {{ old('pay_frequency') == $key ? 'selected' : '' }}>
                                                            {{ $value }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="input-group-append">
                                                <select class="form-control" name="salary_currency">
                                                    ...
                                                    @foreach($currencies as $currency)
                                                        <option value="{{ $currency->name }}" {{ old('salary_currency', get_base_currency()) == $currency->name ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="bank_code" name="bank_code" 
                                                       value="{{ old('bank_code') }}" placeholder="Bank identification code">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="insurance_number" name="insurance_number" 
                                                       value="{{ old('insurance_number') }}" placeholder="Health/Social insurance number">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> {{ _lang('Save Employee') }}
                            </button>
