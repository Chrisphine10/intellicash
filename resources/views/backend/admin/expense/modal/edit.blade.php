<form method="post" class="ajax-submit" autocomplete="off" action="{{ route('expenses.update', $id) }}" enctype="multipart/form-data">
	@csrf
	...
	<div class="row px-2">
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<select class="form-control auto-select select2" data-selected="{{ $expense->bank_account_id }}" name="bank_account_id"  required>
					<option value="">{{ _lang('Select One') }}</option>
