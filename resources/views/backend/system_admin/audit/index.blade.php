    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <span class="panel-title">{{ _lang('System Audit Trail') }}</span>
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-2">
                        <select class="form-control" id="tenant_filter">
                            <option value="">{{ _lang('All Tenants') }}</option>
...
$(document).ready(function() {
    ...
    var table = $('#audit_table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('admin.audit.get_table_data') }}",
            data: function(d) {
...
function loadStatistics() {
    $.ajax({
        url: "{{ route('admin.audit.statistics') }}",
        data: {
...
function downloadExport() {
    ...
    window.location.href = "{{ route('admin.audit.export') }}?" + formData;
