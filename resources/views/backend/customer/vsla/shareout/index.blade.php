    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ _lang('VSLA Cycles') }}</h4>
                <p class="text-muted mb-0">{{ _lang('View your participation and group summary for all VSLA cycles') }}</p>
            </div>
            <div class="card-body">
                @if(!$hasVslaActivity)
                    <div class="alert alert-warning">
                        ...
                        {{ _lang('You do not have any VSLA transactions recorded yet. To participate in VSLA shareouts, you need to make share purchases and other VSLA contributions during active cycles.') }}
                    </div>
                @endif
                        ...
                        <div class="col-lg-6 col-xl-4 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        <a href="{{ route('customer.vsla.cycles.show', $cycle->id) }}" class="btn btn-primary btn-sm btn-block">
