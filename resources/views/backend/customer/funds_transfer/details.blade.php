    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <table class="table table-borderless">
                            ...
                            @if($transfer->transfer_type === 'kcb_buni')
                                ...
                                <tr>
                                    <th>{{ _lang('Bank Code:') }}</th>
                                    <td>{{ $transfer->beneficiary_bank_code }}</td>
                                </tr>
                            @else
                                <tr>
                                    <th>{{ _lang('Mobile Number:') }}</th>
                                    <td>+254{{ $transfer->beneficiary_mobile }}</td>
                                </tr>
                            @endif
                            <tr>
                ...
                @if($transfer->api_response)
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <h6>{{ _lang('API Response:') }}</h6>
                            <div class="card">
                                <div class="card-body">
                                    <pre class="mb-0"><code>{{ json_encode($transfer->api_response, JSON_PRETTY_PRINT) }}</code></pre>
                                </div>
                            </div>
                        </div>
                    </div>
