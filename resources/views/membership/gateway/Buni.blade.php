                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="customer_reference" value="{{ 'MEM-' . $deposit->id . '-' . time() }}" readonly>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="alert alert-info">
                                ...
                                <ol>
                                    ...
                                    <li>{{ _lang('Enter the Customer Reference:') }} <strong>{{ 'MEM-' . $deposit->id . '-' . time() }}</strong></li>
...
function initiateBuniPayment() {
    ...
    fetch('{{ route("gateway.buni.initiate", request()->tenant->slug) }}', {
        ...
        body: JSON.stringify({
            ...
            customer_reference: 'MEM-{{ $deposit->id }}-{{ time() }}',
