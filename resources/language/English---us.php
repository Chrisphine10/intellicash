...
// Lease Request Language Strings
$language["Lease Requests"]="Lease Requests";
$language["My Lease Requests"]="My Lease Requests";
$language["Request Asset Lease"]="Request Asset Lease";
$language["New Lease Request"]="New Lease Request";
$language["Lease Request Details"]="Lease Request Details";
$language["Request Number"]="Request Number";
$language["Select Asset"]="Select Asset";
$language["Duration (Days)"]="Duration (Days)";
$language["Daily Rate"]="Daily Rate";
$language["Total Amount"]="Total Amount";
$language["Deposit Amount"]="Deposit Amount";
$language["Payment Account"]="Payment Account";
$language["Reason for Lease"]="Reason for Lease";
$language["Submit Request"]="Submit Request";
$language["Approve Request"]="Approve Request";
$language["Reject Request"]="Reject Request";
$language["Asset Leasing"]="Asset Leasing";
$language["Lease request submitted successfully"]="Lease request submitted successfully";
$language["Lease request approved and payment processed successfully"]="Lease request approved and payment processed successfully";
$language["Lease request rejected"]="Lease request rejected";
$language["This asset is not available for lease"]="This asset is not available for lease";
$language["Invalid payment account"]="Invalid payment account";
$language["Insufficient balance in the selected payment account"]="Insufficient balance in the selected payment account";
$language["I agree to the terms and conditions for asset leasing"]="I agree to the terms and conditions for asset leasing";
$language["Admin Notes"]="Admin Notes";
...
$language["Optional notes for the member"]="Optional notes for the member";
$language["Approving this request will process payment from the member's account and create an active lease."]="Approving this request will process payment from the member's account and create an active lease.";
$language["This request has been approved and payment processed."]="This request has been approved and payment processed.";
$language["This request has been rejected."]="This request has been rejected.";
$language["Your lease request has been approved! Payment has been processed from your account."]="Your lease request has been approved! Payment has been processed from your account.";
$language["No lease requests found"]="No lease requests found";
$language["All Status"]="All Status";
$language["All Members"]="All Members";
$language["All Assets"]="All Assets";
...
$language["Lease Details"]="Lease Details";
$language["Payment Information"]="Payment Information";
$language["Request Information"]="Request Information";
$language["Account Balance"]="Account Balance";
$language["Total Payment Required"]="Total Payment Required";
$language["Current Status"]="Current Status";
...
$language["Member request is not pending"]="Member request is not pending";
$language["Failed to accept member request"]="Failed to accept member request";
...
$language["Loan Term Duration"]="Loan Term Duration";
$language["Monthly Interest Rate"]="Monthly Interest Rate";
...
$language["Upcoming Payments"]="Upcoming Payments";
