  ...
  const reportCards = useMemo<ReportCard[]>(
    () => {
      ...
      },
      {
        ...
        description: "External loan fund balances by group, county, source, and field owner (the fund as it stands, not a loan-by-loan balance).",
        audience: "Lenders",
        cadence: "Fortnightly",
        ...
        return (
          <DataTable
            columns={[
              ...
              { key: "county", header: "County", value: (row) => row.county },
              { key: "phase", header: "Phase", value: (row) => row.phase },
              { key: "outstanding", header: "Fund balance", value: (row) => row.outstandingCents, exportValue: (row) => row.outstanding, cell: (row) => row.outstanding },
              { key: "members", header: "Members", value: (row) => row.members },
              { key: "agent", header: "VA / FSC", value: (row) => row.agent },
              { key: "source", header: "Source", value: (row) => row.source },
