...
return new class extends Migration
{
    ...
    {
        // Add check constraints for payroll_periods table if it exists
        ...
        // Add check constraints for payroll_items table if it exists
        ...
        // Add check constraints for payroll_deductions table if it exists
        ...
        // Add check constraints for payroll_benefits table if it exists
        if (Schema::hasTable('payroll_benefits')) {
            try {
        ...
        // Add check constraints for employee_deductions table if it exists
        ...
        // Add check constraints for employee_benefits table if it exists
        ...
        // Add check constraints for employees table if it exists
