...
class ESignatureDocumentSentNotification extends Notification
{
    use Queueable;
    ...
    public function __construct(ESignatureDocument $document, ESignatureSignature $signature)
    {
        ...
        $this->template = EmailTemplate::where('slug', 'ESIGNATURE_DOCUMENT_SENT')
        ...
        $this->replace['customMessage'] = $document->custom_message;
