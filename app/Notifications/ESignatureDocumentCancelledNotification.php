...
class ESignatureDocumentCancelledNotification extends Notification
{
    use Queueable;
    ...
    public function __construct(ESignatureDocument $document)
    {
        ...
        $this->template = EmailTemplate::where('slug', 'ESIGNATURE_DOCUMENT_CANCELLED')
        ...
        $this->replace['cancelledAt'] = now()->format('M d, Y \a\t g:i A');
    ...
    public function toArray($notifiable)
    {
        ...
        return [
            ...
            'type' => 'esignature_document_cancelled'
        ];
    }
}
